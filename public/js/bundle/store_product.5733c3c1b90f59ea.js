...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("tr", [_c("td", [_c("span", {
      ...
      staticClass: "text-right"
    }, [_vm._v("\n                        " + _vm._s(_vm.currentUser.currency) + " " + _vm._s(materiel.cost) + "\n                      ")]), _vm._v(" "), _c("td", {
      staticClass: "text-right"
    }, [_vm._v("\n                        " + _vm._s(_vm.currentUser.currency) + "\n                        " + _vm._s(_vm.formatNumber(materiel.cost * materiel.quantity, 2)) + "\n                      ")]), _vm._v(" "), _c("td", {
      staticClass: "text-right"
    }, [_c("a", {
  ...
  }, [_c("tbody", [_c("tr", [_c("td", [_vm._v("Total Cost")]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(_vm.currentUser.currency) + "\n                          " + _vm._s(_vm.formatNumber(_vm.totalCost, 2)))])])])])])])])], 1) : _vm._e(), _vm._v(" "), _c("b-card", {
    staticClass: "mt-3"
  }, [_c("b-row", [_c("b-col", {
    staticClass: "mb-2",
    attrs: {
  ...
  }), _vm._v("\n            " + _vm._s(_vm.$t("submit")))]), _vm._v(" "), _vm.SubmitProcessing ? _vm._m(0) : _vm._e()], 1)], 1)], 1)], 1) : _vm._e()], 1);
};
