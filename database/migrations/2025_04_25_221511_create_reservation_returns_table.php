...
class CreateReservationReturnsTable extends Migration
{
    /**
     * Run the migrations.
     */
    public function up()
    {
        Schema::create('reservation_returns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reservation_returns');
    }
}
