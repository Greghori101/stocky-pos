...
class CreateReservationItemReturnsTable extends Migration
{
    /**
     * Run the migrations.
     */
    public function up()
    {
        Schema::create('reservation_item_returns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reservation_item_returns');
    }
}
