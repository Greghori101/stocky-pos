                  ...
                  <table class="table table-hover table-sm">
                    ...
                    <tbody>
                      ...
                      <tr v-for="materiel in materiels">
                        ...
                        <td class="text-right">
                          {{ currentUser.currency }} {{ materiel.cost }}
                        </td>
                        <td class="text-right">
                          {{ currentUser.currency }}
                          {{
                            formatNumber(materiel.cost * materiel.quantity, 2)
                          }}
                        </td>
            ...
            <b-card class="mt-3">
              <b-row>
                ...
                <b-col
                  ...
                  class="mb-2"
                  v-if="
                    product.type == 'is_single' || product.type == 'is_combo'
                  "
                >
                  <validation-provider
                    name="Product Cost"
